...
class ReviveAdserverCachedContainer extends Container
{
    ...
    {
        return $this->services['filesystem'] = new \League\Flysystem\Filesystem(new \League\Flysystem\Adapter\Local('/home/stevosor/public_html/openx/www/images', 0));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'database.socket' => '',
            'database.port' => '3306',
            'database.username' => 'stevosor_open674',
            'database.password' => '-6o0S-3Wnp',
            'database.name' => 'stevosor_open674',
            'database.persistent' => '',
            ...
            'webpath.admin' => 'stevosoro.xyz/openx/www/admin',
            'webpath.delivery' => 'stevosoro.xyz/openx/www/delivery',
            'webpath.deliverySSL' => 'stevosoro.xyz/openx/www/delivery',
            'webpath.images' => 'stevosoro.xyz/openx/www/images',
            'webpath.imagesSSL' => 'stevosoro.xyz/openx/www/images',
            ...
            'file.xmlrest' => 'ax.php',
            'store.mode' => '0',
            'store.webDir' => '/home/stevosor/public_html/openx/www/images',
            'store.ftpHost' => '',
            'store.ftpPath' => '',
            'store.ftpUsername' => '',
            'store.ftpPassword' => '',
            ...
            'delivery.secret' => 'Zjl6dmZkaG15bm9pbGNrdnJ1eW1saGpsZ2UxbG5jejA=',
            ...
            'email.qmailPatch' => '',
            'email.fromName' => '',
            'email.fromAddress' => 'admin@stevosoro.xyz',
            'email.fromCompany' => '',
